...
EXTRACTED_ATTACK_DATASET_PATH = DATA_FOLDER + PROCESSED_ANOMALY_FOLDER + '{0}/' + EXTRACTED_ATTACK_DATA_FILENAME
EXTRACTED_BENIGN_DATASET_PATH = DATA_FOLDER + PROCESSED_ANOMALY_FOLDER + '{0}/' + EXTRACTED_BENIGN_DATA_FILENAME
