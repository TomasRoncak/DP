...
## FOLDER PATHS ##
ATTACKS_PLOTS_FOLDER          = DATA_FOLDER + PROCESSED_ANOMALY_FOLDER + '{0}/' + BY_PROTOCOLS_FOLDER + '{1}/' + ATTACKS_PLOTS_FOLDER
BENIGN_PLOTS_FOLDER           = DATA_FOLDER + PROCESSED_ANOMALY_FOLDER + '{0}/' + BY_PROTOCOLS_FOLDER + '{1}/' + BENIGN_PLOTS_FOLDER
