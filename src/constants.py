...
METRICS_REGRESSION_WINDOW_FILENAME = 'metrics_regression_window.txt'
METRICS_REGRESSION_TEST_FILENAME = 'metrics_regression_test.txt'
...
EXTRACTED_DATASETS_PLOTS_FOLDER = EXTRACTED_DATASETS_FOLDER + 'plots/{1}/'
...
MODEL_REGRESSION_WINDOW_METRICS_PATH = METRICS_FOLDER + METRICS_REGRESSION_WINDOW_FILENAME
MODEL_REGRESSION_TEST_METRICS_PATH = METRICS_FOLDER + METRICS_REGRESSION_TEST_FILENAME
