...
TIME_WINDOW_NUMBERED_SET_FOLDER = 'time_window_{2}/'
...
ATTACK_CATEGORY_DATASET_FILE = '{0}_dataset.csv'
...
TRAIN_VAL_DATASET_FILE = 'train_val_dataset.csv'
...
CAT_TRAIN_VAL_DATASET = PREPROCESSED_CAT_PATH + TRAIN_VAL_DATASET_FILE
CAT_TEST_DATASET = PREPROCESSED_CAT_PATH + TEST_DATASET_FILE
CAT_ATTACK_CATEGORY_DATASET = PREPROCESSED_CAT_PATH + ATTACK_CATEGORY_DATASET_FILE
...
MODEL_PREDICTIONS_ATTACK_PATH = WHOLE_ANOMALY_MODEL_PATH + '{1}/' + PREDICTIONS_ATTACK_FOLDER + TIME_WINDOW_NUMBERED_SET_FOLDER
...
METRICS_CLASSIFICATION_WINDOW_FOLDER_PATH = '{0}{1}/' + METRICS_FOLDER + TIME_WINDOW_NUMBERED_SET_FOLDER
