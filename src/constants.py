...
## FOLDER PATHS ##
ATTACKS_PLOTS_BY_ATT_FOLDER  = DATA_FOLDER + PROCESSED_ANOMALY_FOLDER + '{0}/' + BY_ATTACK_CAT_FOLDER + '{1}/' + PLOTS_FOLDER
...
PROCESSED_ATTACK_FOLDER       = DATA_FOLDER + PROCESSED_ANOMALY_FOLDER + '{0}/' + BY_ATTACK_CAT_FOLDER + '{1}/'
...
TS_ATTACK_CATEGORY_DATASET_PATH = PROCESSED_ATTACK_FOLDER + ATTACKS_FILENAME
