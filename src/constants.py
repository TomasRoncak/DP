...
CLASSIFICATION_MODEL_FOLDER = 'classification_model/'
DATA_FOLDER = 'data/'
...
WHOLE_CLASSIFICATION_MODEL_PATH = MODEL_FOLDER + CLASSIFICATION_MODEL_FOLDER

SAVE_ANOMALY_MODEL_PATH = WHOLE_ANOMALY_MODEL_PATH + SAVINGS_FOLDER
SAVE_CAT_MODEL_PATH = WHOLE_CLASSIFICATION_MODEL_PATH + SAVINGS_FOLDER
